...
CREATE TABLE IF NOT EXISTS article_comments (
  ...
  reactions_like INT UNSIGNED NOT NULL DEFAULT 0,
  reactions_smile INT UNSIGNED NOT NULL DEFAULT 0,
  reactions_dislike INT UNSIGNED NOT NULL DEFAULT 0,
  reactions_clap INT UNSIGNED NOT NULL DEFAULT 0,
  reactions_blueheart INT UNSIGNED NOT NULL DEFAULT 0,
