...
2. Sélectionnez votre propriété "digitalblueskye.com" (ou ajoutez-la si absent)
3. **Inspecter l'URL:**
   - Cliquez sur "URL Inspection" (🔍 icône en haut)
   - Collez : `https://digitalblueskye.com/blog/digital/article-seo-chef-projet.html`
   - Cliquez "Request Indexing"
4. **Soumettre le Sitemap:**
   - Allez à "Sitemaps" (colonne gauche)
   - Cliquez "New Sitemap"
   - Entrez : `https://digitalblueskye.com/sitemap.xml`
   - Cliquez "Submit"
...
2. Copiez URL article : `https://digitalblueskye.com/blog/digital/article-seo-chef-projet.html`
...
- [ ] Article 8 visible dans `site:digitalblueskye.com`
...
- Vérifier robots.txt contient : `Sitemap: https://digitalblueskye.com/sitemap.xml`
...
A: Vérifier site:digitalblueskye.com. Si rien: peut être en sandbox (~30 jours pour nouveau domaine). Soumettez sitemap et attendez.
