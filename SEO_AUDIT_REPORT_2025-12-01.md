...
<meta property="og:url" content="https://digitalblueskye.com/blog/digital/article-*.html" />
```
...
**Implémentation:**
```html
<link rel="canonical" href="https://digitalblueskye.com/blog/digital/article-*.html" />
```
...
// Injection dynamique Article schema.org
{
  ...
  "author": {
    ...
    "url": "https://digitalblueskye.com"
  },
  "datePublished": "[ISO 8601 date]",
  "publisher": {
    "@type": "Organization",
    "name": "Digitalblueskye",
    "logo": "https://digitalblueskye.com/assets/images/logo/Logo-Globe.png"
  }
}
```
**Bénéfice:**
...
<!-- Ajout article 8 -->
<url>
  <loc>https://digitalblueskye.com/blog/digital/article-seo-chef-projet.html</loc>
...
2. **Search Console Indexing Request**
   ...
   - Étapes :
     ...
     2. Sélectionner propriété "digitalblueskye.com"
...
- [ ] Article 8 indexé dans Google (vérifier via `site:digitalblueskye.com`)
...
```bash
site:digitalblueskye.com/blog/digital/
```

### Vérifier meta tags en production
```bash
curl -s https://digitalblueskye.com/blog/digital/article-seo-chef-projet.html | grep -i "meta name=\"description\""
```

### Valider sitemap XML
```bash
curl -s https://digitalblueskye.com/sitemap.xml | xmllint --format -
```
